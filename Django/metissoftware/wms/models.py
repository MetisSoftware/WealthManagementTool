...
class FAUserManager(BaseUserManager):
    def create_user(self, email, first_name, surname, is_superuser,
                    dob, ni_number, password=None, **extra_fields):
        if not email:
    ...
    def create_superuser(self, email, first_name, surname,
        ...
        user = self.create_user(email, first_name, surname, ni_number,
